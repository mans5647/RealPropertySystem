...
public final class Codes 
{
    ...
    public static final int AuthErrorNoHeader = 1;
    public static final int AuthErrorFailed = 2;
    public static final int AuthTokenInvalid = 3;
    public static final int AuthLoginNotFound = 4;
